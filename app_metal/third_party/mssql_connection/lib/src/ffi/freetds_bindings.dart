...
const int INT_CANCEL = 2; // DB-Lib error cancellation
...
/// Selectors: DBSETUSER, DBSETPWD, DBSETCHARSET.
...
class DBLib {
  ...
  - Exposes login option wrappers that map to dbsetlname selectors.
  ...
  Typical lifecycle:
  1) dbinit()
  2) final login = dblogin(); set user, password, and client charset.
  ...
  Notes:
  - DBSETL* macros in sybdb.h use dbsetlname under the hood.
