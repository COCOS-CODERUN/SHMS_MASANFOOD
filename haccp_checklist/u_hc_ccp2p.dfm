object f_hc_ccp2p: Tf_hc_ccp2p
    ...
    object cxGBox_Info: TcxGroupBox
      ...
      object cxGInfo: TcxGrid
        ...
        object cxGInfoDBBTv_: TcxGridDBBandedTableView
          ...
          object cxGInfoDBBTv_ccp2p_hid: TcxGridDBBandedColumn
            DataBinding.FieldName = 'ccp2p_hid'
    ...
    object cxGBox_Out: TcxGroupBox
      ...
      object cxGOut: TcxGrid
        ...
        object cxGOutDBTv_: TcxGridDBTableView
          ...
          OptionsView.ColumnAutoWidth = True
          OptionsView.GroupByBox = False
          object cxGOutDBTv_ccp2p_outid: TcxGridDBColumn
            DataBinding.FieldName = 'ccp2p_outid'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
          ...
          object cxGOutDBTv_ccp2p_hid: TcxGridDBColumn
            DataBinding.FieldName = 'ccp2p_hid'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
    ...
    object cxGBox_D: TcxGroupBox
      ...
      object cxGD: TcxGrid
        ...
        object cxGDDBTv_: TcxGridDBTableView
          ...
          OptionsView.ColumnAutoWidth = True
          OptionsView.GroupByBox = False
          object cxGDDBTv_ccp2p_did: TcxGridDBColumn
            DataBinding.FieldName = 'ccp2p_did'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
            Properties.ReadOnly = False
          ...
          object cxGDDBTv_ccp2p_hid: TcxGridDBColumn
            DataBinding.FieldName = 'ccp2p_hid'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
    ...
    object cxGroupBox2: TcxGroupBox
      ...
      object cxGD2: TcxGrid
        ...
        object cxGD2DBTv_: TcxGridDBTableView
          ...
          OptionsView.ColumnAutoWidth = True
          OptionsView.GroupByBox = False
          object cxGD2DBTv_ccp2p_d2id: TcxGridDBColumn
            DataBinding.FieldName = 'ccp2p_d2id'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
            Properties.ReadOnly = False
          ...
          object cxGD2DBTv_ccp2p_hid: TcxGridDBColumn
            DataBinding.FieldName = 'ccp2p_hid'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
  ...
  object uq_info: TUniQuery
    SQLInsert.Strings = (
      ...
      '            ,hb.Level3 '
      '        from HaccpBasic hb '
      '        where hb.MenuName = '#39#51473#50836#44288#47532#51216'(CCP-2P) '#47784#45768#53552#47553#51068#51648#39
      '    ) as tbl_hb'
      '    pivot ('
  ...
  object uq_d: TUniQuery
    SQLInsert.Strings = (
      ...
      ' where hcpd.ccp2p_hid = :ccp2p_hid')
    SQL.Strings = (
      'select ccp2p_did'
      '      ,ccp2p_hid'
      '      ,f_no'
  ...
  object uq_out: TUniQuery
    SQLInsert.Strings = (
      ...
      'where hcpo.ccp2p_hid = :ccp2p_hid')
    SQL.Strings = (
      'select hcpo.ccp2p_outid '
      '      ,hcpo.ccp2p_hid '
      '      ,hcpo.details '
  ...
  object uq_insert: TUniQuery
    SQLInsert.Strings = (
      'if coalesce(:ccp2p_hid, 0) = 0'
      'begin'
      '    insert into hc_ccp2p_h'
      ...
      '        ,writer    = :writer       '
      '    where ccp2p_hid = :ccp2p_hid'
      '    select :ccp2p_hid as "index"'
      'end')
    SQLDelete.Strings = (
      'if coalesce(:ccp2p_d2id, 0) = 0'
      'begin'
      '    insert into hc_ccp2p_d2'
      '    (ccp2p_hid,f_no,Qty,detection,remark)'
      '    values'
      '    (:ccp2p_hid,:f_no,:Qty,:detection,:remark)'
      '    select @@IDENTITY as "index"'
      'end'
      'else'
      'begin'
      '    update hc_ccp2p_d2 set'
      '         f_no        = :f_no         '
      '        ,Qty         = :Qty  '
      '        ,detection   = :detection    '
      '        ,remark      = :remark'
      '    where ccp2p_d2id = :ccp2p_d2id'
      'end')
    SQLUpdate.Strings = (
      'if coalesce(:ccp2p_did, 0) = 0'
      'begin'
      '    insert into hc_ccp2p_d'
      
        '    (ccp2p_hid,f_no,itemname,checktime,pass_fe,pass_sus,pass_ite' +
        'm,pass_feitem,pass_susitem,writer)'
      '    values'
      
        '    (:ccp2p_hid,:f_no,:itemname,:checktime,:pass_fe,:pass_sus,:p' +
        'ass_item,:pass_feitem,:pass_susitem,:writer)'
      '    select @@IDENTITY as "index"'
      'end'
      'else'
      'begin'
      '    update hc_ccp2p_d set'
      '         f_no = :f_no         '
      '        ,itemname     = :itemname  '
      '        ,checktime    = :checktime    '
      '        ,pass_fe      = :pass_fe    '
      ...
      '        ,writer       = :writer       '
      '    where ccp2p_did   = :ccp2p_did'
      'end')
    SQLLock.Strings = (
      'select * from hc_ccp2p_out'
      'if coalesce(:ccp2p_outid, 0) = 0'
      'begin'
      #9'insert into hc_ccp2p_out'
      #9'(ccp2p_hid, details, results, writer, reviewer)'
      #9'values'
      #9'(:ccp2p_hid, :details, :results, :writer, :reviewer)'
      'end'
      'else'
      'begin'
      #9'update hc_ccp2p_out set '
      #9#9'  details'#9'= :details'#9
      #9#9' ,results'#9'= :results'#9
      #9#9' ,writer'#9'= :writer'#9
      #9#9' ,reviewer'#9'= :reviewer'#9
      #9'where ccp2p_outid = :ccp2p_outid'
      'end')
    Left = 32
    Top = 120
  end
  ...
  object uq_delete: TUniQuery
    SQLInsert.Strings = (
      'delete from hc_ccp2p_d'
      'where ccp2p_did = :ccp2p_did')
    SQLDelete.Strings = (
      'delete from hc_ccp2p_out'
      'where ccp2p_outid = :ccp2p_outid')
    SQLUpdate.Strings = (
      'delete from hc_ccp2p_d2'
      'where ccp2p_d2id = :ccp2p_d2id')
    SQLLock.Strings = (
      'delete from hc_ccp2p_out'
      'where ccp2p_hid = :ccp2p_hid'
