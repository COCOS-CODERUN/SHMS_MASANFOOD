object f_hc_ccp1b: Tf_hc_ccp1b
    ...
    object cxGBox_Info: TcxGroupBox
      ...
      object cxGInfo: TcxGrid
        ...
        object cxGInfoDBBTv_: TcxGridDBBandedTableView
          ...
          object cxGInfoDBBTv_ccp1b_hid: TcxGridDBBandedColumn
          ...
          object cxGInfoDBBTv_temp1: TcxGridDBBandedColumn
            Caption = #54620#44228#44592#51456' '#44396#51060#50728#46020'(1'#52264')'
          ...
          object cxGInfoDBBTv_temp2: TcxGridDBBandedColumn
            Caption = #54620#44228#44592#51456' '#44396#51060#50728#46020'(2'#52264')'
          ...
          object cxGInfoDBBTv_temp3: TcxGridDBBandedColumn
            Caption = #54620#44228#44592#51456' '#44396#51060#50728#46020'(3'#52264')'
    ...
    object cxGBox_Out: TcxGroupBox
      ...
      object cxGOut: TcxGrid
        ...
        object cxGOutDBTv_: TcxGridDBTableView
          ...
          OptionsView.ColumnAutoWidth = True
          OptionsView.GroupByBox = False
          object cxGOutDBTv_ccp1b_hid: TcxGridDBColumn
            DataBinding.FieldName = 'ccp1b_hid'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
          ...
          object cxGOutDBTv_ccp1b_outid: TcxGridDBColumn
            DataBinding.FieldName = 'ccp1b_outid'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
    ...
    object cxGBox_D: TcxGroupBox
      ...
      object cxGD: TcxGrid
        ...
        object cxGDDBTv_: TcxGridDBTableView
          ...
          OptionsView.ColumnAutoWidth = True
          OptionsView.GroupByBox = False
          object cxGDDBTv_ccp1b_did: TcxGridDBColumn
            DataBinding.FieldName = 'ccp1b_did'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
            Properties.ReadOnly = False
          ...
          object cxGDDBTv_ccp1b_hid: TcxGridDBColumn
            DataBinding.FieldName = 'ccp1b_hid'
            DataBinding.IsNullValueType = True
            PropertiesClassName = 'TcxTextEditProperties'
            Properties.Alignment.Horz = taCenter
  ...
  object uq_info: TUniQuery
    SQLInsert.Strings = (
      ...
      '            ,hb.Level3 '
      '        from HaccpBasic hb '
      '        where hb.MenuName = '#39#51473#50836#44288#47532#51216'(CCP-1B) '#47784#45768#53552#47553#51068#51648#39
      '    ) as tbl_hb'
      '    pivot ('
  ...
  object uq: TUniQuery
    SQLInsert.Strings = (
      'if coalesce(:ccp1b_hid, 0) = 0'
      'begin'
      #9'insert into hc_ccp1b_h'
      
        #9'(checkdate, writer, temp1, temp2, temp3, speed, cycle, way, bet' +
        'terway)'
      #9'values'
      
        #9'(:checkdate, :writer, :temp1, :temp2, :temp3, :speed, :cycle, :' +
        'way, :betterway)'
      #9'select @@IDENTITY as "index"'
      'end'
      'else'
      'begin'
      #9'update hc_ccp1b_h set'
      ...
      #9'where ccp1b_hid = :ccp1b_hid'
      '        select :ccp1b_hid as "index"'
      'end')
    SQLDelete.Strings = (
      'select * from hc_ccp1b_out'
      'if coalesce(:ccp1b_outid, 0) = 0'
      'begin'
      #9'insert into hc_ccp1b_out'
      #9'(ccp1b_hid, details, results, writer, reviewer)'
      #9'values'
      #9'(:ccp1b_hid, :details, :results, :writer, :reviewer)'
      'end'
      'else'
      'begin'
      #9'update hc_ccp1b_out set '
      #9#9'  details'#9'= :details'#9
      #9#9' ,results'#9'= :results'#9
      #9#9' ,writer'#9'= :writer'#9
      #9#9' ,reviewer'#9'= :reviewer'#9
      #9'where ccp1b_outid = :ccp1b_outid'
      'end')
    SQLUpdate.Strings = (
      'if coalesce(:ccp1b_did, 0) = 0'
      'begin'
      #9'insert into hc_ccp1b_d'
      
        #9'(ccp1b_hid, f_no, itemname, checktime, temp1, temp2, temp3, spe' +
        'ed, remark, writer)'
      #9'values'
      
        #9'(:ccp1b_hid, :f_no, :itemname, :checktime, :temp1, :temp2, :tem' +
        'p3, :speed, :remark, :writer)'
      'end'
      'else'
      'begin'
      #9'update hc_ccp1b_d set'
      #9#9' f_no'#9'   = :f_no'#9'   '
      ...
      #9#9',writer'#9'   = :writer'#9'   '
      #9'where ccp1b_did = :ccp1b_did'
      'end')
    SQLLock.Strings = (
      'delete from hc_ccp1b_out'
      'where ccp1b_hid = :ccp1b_hid'
      'delete from hc_ccp1b_d'
      'where ccp1b_hid = :ccp1b_hid'
      'delete from hc_ccp1b_h'
      'where ccp1b_hid = :ccp1b_hid')
    SQLRefresh.Strings = (
      'delete from hc_ccp1b_d'
      'where ccp1b_did = :ccp1b_did')
    SQLRecCount.Strings = (
      'delete from hc_ccp1b_out'
      'where ccp1b_outid = :ccp1b_outid')
    Left = 32
    Top = 120
  end
