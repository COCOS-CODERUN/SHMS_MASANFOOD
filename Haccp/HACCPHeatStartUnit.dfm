object HACCPHeatStartForm: THACCPHeatStartForm
  ...
  object cxGroupBox3: TcxGroupBox
    ...
    Margins.Bottom = 2
    Align = alBottom
    Caption = #50728#46020#54788#54889'(10'#48516' '#45800#50948' '#54788#54889#51077#45768#45796')'
    ParentFont = False
    Style.Font.Charset = DEFAULT_CHARSET
    Style.Font.Color = clWindowText
    Style.Font.Height = -20
  ...
  object uq_temp: TUniQuery
    SQLInsert.Strings = (
      'SELECT *'
      'FROM ('
      #9'SELECT '#39#50728#46020#39' as '#39'FridgeNo'#39', Temp, Name'
      #9'FROM Fridge AS F'
      
        #9'LEFT OUTER JOIN TempCheck AS T ON F.FridgeNo = T.FridgeNo AND C' +
        'heckDate = (SELECT MAX(CheckDate) FROM TempCheck WHERE FridgeNo ' +
        '= F.FridgeNo)'
      #9'WHERE LEFT(F.FridgeCode, 2) = '#39'CH'#39#9
      #9'AND   CAST(CheckDate AS DATE) = CAST(GETDATE() AS DATE)'
      #9') tbl_temp'
      'pivot ('
