inherited CCPHeatCheckForm2: TCCPHeatCheckForm2
  Caption = 'CCPHeatCheckForm2'
  OnCreate = FormCreate
  TextHeight = 17
  ...
  object cxGBox_Client: TcxGroupBox
    ...
    object cxGBox_input: TcxGroupBox
      ...
      object cxBtn_start: TcxButton
        Tag = 4
        Left = 109
        Top = 76
        Width = 100
        Height = 26
        Caption = #49884#51089#54616#44592
        LookAndFeel.NativeStyle = False
        LookAndFeel.SkinName = 'Lilian'
        OptionsImage.Glyph.SourceDPI = 96
        OptionsImage.Glyph.Data = {
      ...
      object cxEdit_start: TcxTextEdit
        Left = 209
        Top = 75
        AutoSize = False
        ParentFont = False
    ...
    object cxGrid_List: TcxGrid
      ...
      object cxGridTv_List: TcxGridTableView
        ...
        object cxGridTv_List_temp: TcxGridColumn
          ...
          PropertiesClassName = 'TcxTextEditProperties'
          Properties.Alignment.Horz = taCenter
          OnCustomDrawCell = cxGridTv_List_tempCustomDrawCell
          HeaderAlignmentHorz = taCenter
          Options.Editing = False
          Width = 80
        end
